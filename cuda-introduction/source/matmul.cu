...
int main(int argc, char *argv[])
{
    ...
    const unsigned sizeMX = 771;
    const unsigned sizeXY = 771;
    ...
    dims.dimGrid  = dim3(sizeMX/32, sizeNY/32, 1);
    ...
    CUDA(cudaMemcpy(matrixP, d_matrixP, sizeNY * sizeMX * sizeof(float), cudaMemcpyDeviceToHost));
